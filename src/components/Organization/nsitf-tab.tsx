...
export const NsitfTab = (props: RemittanceTabProps) => {
          ...
          return (
            ...
            >
                ...
                <div className="info__remittance__input-cont">
                  <div>
                    <InputV2
                      ...
                      error={touched.nsitfId && errors.nsitfId}
                      value={values.nsitfId}
                      onBlur={handleBlur}
                      onChange={handleChange}
                    />
                  </div>
              ...
              <div className="info__remittance__form__action">
                ...
                <Button
                  element="a"
                  href="/organisations/remittance-employees?tab=nsitf"
